...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/04/2026 às 18:38
...
(1, 'Thomas Dias Batista', '12345678901', 'thomas.d@estudante.com', '2007-02-22', 'Ativo', '2026-04-25 16:36:45'),
(2, 'Lucas Ferreira Santos', '11122233344', 'lucas.ferreira@estudante.com', '2005-08-15', 'Ativo', '2026-04-25 16:36:45'),
(3, 'Juliana Mendes Costa', '55566677788', 'ju.mendes@estudante.com', '2004-03-12', 'Ativo', '2026-04-25 16:36:45'),
(4, 'Gabriel Rocha Almeida', '98765432100', 'gabriel.rocha@estudante.com', '2003-11-30', 'Trancado', '2026-04-25 16:36:45');
...
--
ALTER TABLE `dim_aluno`
  MODIFY `sk_aluno` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `dim_curso`
--
ALTER TABLE `dim_curso`
  MODIFY `sk_curso` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `dim_professor`
--
ALTER TABLE `dim_professor`
  MODIFY `sk_professor` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `dim_tempo`
--
ALTER TABLE `dim_tempo`
  MODIFY `sk_tempo` int(11) NOT NULL AUTO_INCREMENT;
