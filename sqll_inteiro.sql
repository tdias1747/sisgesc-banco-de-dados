...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/04/2026 às 21:30
...
INSERT INTO `dim_tempo` (`sk_tempo`, `data_referencia`, `mes`, `ano`) VALUES
(1, '2026-04-11', 4, 2026),
(2, '2026-04-10', 4, 2026),
(3, '2026-04-08', 4, 2026),
(4, '2026-04-25', 4, 2026);
...
(1, 'Thomas Dias Batista', '12345678901', 'thomas.d@estudante.com', '2007-02-22', 'Ativo'),
(2, 'Lucas Ferreira Santos', '11122233344', 'lucas.ferreira@estudante.com', '2005-08-15', 'Ativo'),
(3, 'Juliana Mendes Costa', '55566677788', 'ju.mendes@estudante.com', '2004-03-12', 'Ativo'),
(4, 'Gabriel Rocha Almeida', '98765432100', 'gabriel.rocha@estudante.com', '2003-11-30', 'Trancado');
...
ALTER TABLE `fato_sisgesc`
  ...
  ADD KEY `idx_fato_aluno` (`sk_aluno`),
  ADD KEY `idx_fato_curso` (`sk_curso`);
